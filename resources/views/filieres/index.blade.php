    ...
    <div class="container-fluid pt-4 px-4">
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                ...
                <a href="{{ route('filiere.create') }}" class="btn btn-success">Ajouter une filière</a>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <li>
                                                <button class="btn btn-primary"
                                                    onclick="window.location.href='{{ route('filiere.etudiants', $filiere->id) }}'">
                                                    Etudiants
                                                </button>
                                            </li>
                                            <li>
                                                <button class="btn btn-primary btn-sm"
                                                    onclick="window.location.href='{{ route('filiere.modules', $filiere->id) }}'">
                                                    Modules
                                                </button>
                                            </li>
                                        </ul>
