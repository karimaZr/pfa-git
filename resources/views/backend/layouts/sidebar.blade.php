...
<aside class="control-sidebar control-sidebar-dark" style="top: 56.5714px; display: block;">
    ...
    <div class="p-3 control-sidebar-content os-host os-theme-light os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition os-host-overflow os-host-overflow-y"
        ...
        <div class="os-content-glue" style="margin: -16px; width: 249px; height: 458px;"></div>
        <div class="os-padding">
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
                <div class="os-content" style="padding: 16px; height: 100%; width: 100%;">
                    <h5>Customize AdminLTE</h5>
                    <hr class="mb-2">
                    <div class="mb-4"><input type="checkbox" value="1" checked="checked"
                    ...
                    <div class="d-flex"><select class="custom-select mb-3 text-light border-0 bg-dark">
        ...
        <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
            <div class="os-scrollbar-track">
                <div class="os-scrollbar-handle" style="transform: translate(0px, 0px); height: 35.5538%;"></div>
            </div>
        </div>
